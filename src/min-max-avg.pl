...
% !! Recursive case: compare the head of the list (H) with the minimum value in the rest of the list (Min)
min([H|T], Min) :-
...
% !! Recursive case: compare the head of the list (H) with the maximum value in the rest of the list (Max)
max([H|T], Max) :-
